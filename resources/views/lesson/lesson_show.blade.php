...
<form action="{{ url('/user/lesson/reserve') }}" method="post" enctype="multipart/form-data">
{{ csrf_field() }}
...
<div style="margin:45px 15% 0;">
    <div class="row">
        <div class="col-sm-12 text-center">
            <h6 class="text-danger">Lesson Reservation</h6>
            <div style="font-size:50px;font-weight: 900;">レッスンを予約する</div>
            <h5 class="mt-3" style="font-weight: 400;">レッスンを予約します。<br>予約ボタンを押すと確定されます。</h5>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-6" style="width:100%; height:600px; overflow:auto;"><!-- 講師表示 -->
            <div class="mt-4">
                    ...
                    <div class="p-4 bg-white" style="border: 1px solid; border-radius: 6px; border-color: #CCCCCC;"><!-- 枠線 -->
                        <div class="row sample1">
                            ...
                            <div class="col-sm-5 pt-1 text-center">
                                @if( strcmp($lessonRow->user->picturePass,'noImage.png') == 0)
                            ...
                            <div class="col-sm-7 pt-3">
                                ...
                                言語 : <img src="{{ asset('/image/lang' . $lessonRow->user->language_id . '.png') }}" alt="{{ $languageRow[($lessonRow->user->language_id)-1]->name }}" class="langSizeProfile">
                            </div>
                ...
                <div class="mt-5">
                    <button id="modalActivate" type="button" class="btn btn-primary btn-block" data-toggle="modal" data-target="#modalPreview0">予約する ></button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="modalPreviewLabel0">レッスンを予約します</h3>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body" style="padding:40px;">
                <h6 class="pb-5">□予約後、このレッスンは「レッスン一覧」の「受講前」<br>　に移動します。<br>□予約後、受講者と講師両方に通知メールが送信<br>　されます。<br>□レッスンを開始する場合は、レッスン一覧から<br>　「レッスンを始める」を選択します。</h6>
