...
<form action="{{ url('/user/lesson/detail/cancel0') }}" method="post" enctype="multipart/form-data">
{{ csrf_field() }}
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="padding:40px;">
                ...
                <a href="{{ url('/user/lesson/aRoom/' . $lessonRow->id) }}" class="btn btn-primary btn-block">レッスンを開始する</a>
            </div>
