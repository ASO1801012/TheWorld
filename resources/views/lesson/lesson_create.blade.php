...
function onRadioButtonChange() {
    ...
    @for($i = 1; $i <= 13; $i++)
        radiobtn{{ $i }} = document.getElementById("radioLang{{ $i }}");
    @endfor
    // 変数作成
    ...
    @for($i = 2; $i <= count($languageRow); $i++)
        else if (radiobtn{{ $i }}.checked == true) {
            target.innerHTML = 
...
<div style="margin:0 15%;">
    <div class="row">
        <div class="col-sm-6"><!-- プレビュー表示 -->
            <div class="card text-center" style="margin:40px 50px 0 50px; padding-top:60px;">
                <div id="output">
                    <img src="{{ asset('/image/lang13.png') }}" alt="言語未選択" class="langSizePreview"><h3 class="m-4" style="font-weight: 900; color:#999999">言語を選択</h3>
                </div>
                <br>
                ...
                <div class="card mr-5 ml-5 mb-5">
                    <br><p><div id="span2"></div></p><br>
                </div>
            </div>
        </div>

        <div class="col-sm-6" style="width:100%; height:600px; overflow:auto;"><!-- ラジオボタン表示 -->
            <div class="m-5">
                <div class="mb-5">
                ...
                <div class="p-4 text-center bg-white" style="border: 1px solid; border-radius: 6px; border-color: #CCCCCC;"><!-- 枠線 -->
                    ...
                    @if($errors->has('language_id'))
                        <tr><th><font color="red">*{{$errors->first('language_id')}}</font></th></tr>
                    @endif
                </div>
                ...
                <div class="p-4 text-center bg-white" style="border: 1px solid; border-radius: 6px; border-color: #CCCCCC;"><!-- 枠線 -->
                    ...
                    <!--Basic textarea-->
                    @if($errors->has('intro'))
                        <tr><th><font color="red">*{{$errors->first('intro')}}</font></th></tr>
                    @endif
                </div>
                ...
                <div class="p-4 text-center bg-white" style="border: 1px solid; border-radius: 6px; border-color: #CCCCCC;"><!-- 枠線 -->
                    ...
                    @if($errors->has('dualData'))
                        <tr><th><font color="red">*{{$errors->first('dualData')}}</font></th></tr>
                    @endif
                </div>
                ...
                <table border="1" class="table table-striped">
                    <thead>
                        <tr>
                            ...
                            ?>
                                <th scope="col">{{ $showDate.'('.$showWeek[$weekKey].')' }}</th>
                            @endfor
                        </tr>
                    </thead>
                    <tbody>
